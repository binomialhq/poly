...
func TestIsLetter(t *testing.T) {
	...
	if !IsLetter('a') {
		t.Log("L-class character unexpectedly rejected")
		t.Fail()
	}
	if !IsLetter('ɮ') {
		t.Log("L-class character unexpectedly rejected")
	...
	if IsLetter('\t') {
		t.Log("Z-class character unexpectedly accepted")
		t.Fail()
	}
	if IsLetter('\n') {
		t.Log("Z-class character unexpectedly accepted")
	...
	if IsLetter('0') {
		t.Log("N-class character unexpectedly accepted")
		t.Fail()
	}
	if IsLetter('𐒦') {
		t.Log("N-class character unexpectedly accepted")
	...
	if !IsLetter('_') {
		t.Log("P-class character unexpectedly rejected")
		t.Fail()
	}
	if IsLetter('—') {
		t.Log("P-class character unexpectedly accepted")
		t.Fail()
	}
	if IsLetter('゠') {
		t.Log("P-class character unexpectedly accepted")
...
func TestIsDecimal(t *testing.T) {
	...
	if !IsDecimal('0') {
		t.Log("arab numeral character unexpectedly rejected")
		t.Fail()
	}
	if !IsDecimal('1') {
		t.Log("arab numeral character unexpectedly rejected")
	...
	if IsDecimal('a') {
		t.Log("L-class character unexpectedly accepted")
		t.Fail()
	}
	if IsDecimal('ɮ') {
		t.Log("L-class character unexpectedly accepted")
...
func TestIsWhitespace(t *testing.T) {
	...
	if !IsWhitespace('\u0009') {
		t.Log("unexpectedly rejected Latin-1 space character")
	} // \t
	if !IsWhitespace('\u00A0') {
		t.Log("unexpectedly rejected Latin-1 space character")
	} // \n
	...
	if !IsWhitespace('\u2028') {
		t.Log("unexpectedly rejected category Z space character")
	} // Line separator
	if !IsWhitespace('\u2029') {
		t.Log("unexpectedly rejected category Z space character")
	} // Paragraph separator
	...
	if IsWhitespace('a') {
		t.Log("unexpectedly accepted category L character")
		t.Fail()
	}
	if IsWhitespace('ɮ') {
		t.Log("unexpectedly accepted category L character")
	...
	// Must reject N-class unicode characters
	if IsWhitespace('0') {
		t.Log("unexpectedly accepted category N character")
		t.Fail()
	}
	if IsWhitespace('𐒦') {
		t.Log("unexpectedly accepted category N character")
	...
	if IsWhitespace('_') {
		t.Log("unexpectedly accepted category P character")
		t.Fail()
	}
	if IsWhitespace('—') {
		t.Log("unexpectedly accepted category P character")
...
func TestReadRuneAndCountNormal(t *testing.T) {
	...
	if code != 'p' {
		t.Log("wrong code point read first from input string")
		t.Fail()
	}
	if size != 1 {
		t.Log("wrong code point size read first from input string")
		t.Fail()
	}
	if err != nil {
		t.Log("unexpected error when reading valid unicode")
		t.Fail()
	}

	if reader.Line != 1 {
		t.Log("wrong line count after reading one character")
		t.Fail()
	}
	if reader.Column != 1 {
		t.Log("wrong column count after reading one character")
		t.Fail()
	}
	if reader.Offset != 1 {
		t.Log("wrong offset count after reading one byte")
		t.Fail()
	}
	...
	if code != 'Ø' {
		t.Log("wrong code point read second from input string")
		t.Fail()
	}
	if size != 2 {
		t.Log("wrong code point size read second from input string")
		t.Fail()
	}
	if err != nil {
		t.Log("unexpected error when reading valid unicode")
	...
	if reader.Line != 1 {
		t.Log("wrong line count after reading two characters")
		t.Fail()
	}
	if reader.Column != 2 {
		t.Log("wrong column count after reading two characters")
		t.Fail()
	}
	if reader.Offset != 3 {
		t.Log("wrong offset count after reading three bytes")
		t.Fail()
	}
}
...
func TestReadRuneAndCountWithValidBOM(t *testing.T) {
	...
	if code != BOM {
		t.Log("wrong BOM code point read from input string")
		t.Fail()
	}
	if size != BOMSize {
		t.Log("wrong BOM code point size read from input string")
		t.Fail()
	}
	if err != nil {
		t.Log("unexpected error when reading BOM")
		t.Fail()
	}

	if reader.Line != 1 {
		t.Log("wrong line count after reading BOM")
		t.Fail()
	}
	if reader.Column != 0 {
		t.Log("wrong column count after reading BOM")
		t.Fail()
	}
	if reader.Offset != BOMSize {
		t.Log("wrong offset count after reading BOM")
		t.Fail()
	}
	...
	if code != 'p' {
		t.Log("wrong code point read from input string")
		t.Fail()
	}
	if size != 1 {
		t.Log("wrong code point size read from input string")
		t.Fail()
	}
	if err != nil {
		t.Log("unexpected error when reading from input string")
		t.Fail()
	}

	if reader.Line != 1 {
		t.Log("wrong line count when reading after BOM")
		t.Fail()
	}
	if reader.Column != 1 {
		t.Log("wrong column count when reading after BOM")
		t.Fail()
	}
	if reader.Offset != BOMSize+1 {
		t.Log("wrong offset count when reading after BOM")
		t.Fail()
	}
}
...
func TestReadRuneAndCountWithInvalidUnicode(t *testing.T) {
	...
	if code != unicode.ReplacementChar {
		t.Log("unexpected code point read from input string")
		t.Fail()
	}
	if size != 1 {
		t.Log("wrong code point size read from input string")
	...
	if err == nil {
		t.Log("expected an error when reading invalid unicode code point")
		t.Fail()
	}

	if reader.Line != 1 {
		t.Log("wrong line count after reading invalid unicode code point")
		t.Fail()
	}
	if reader.Column != 1 {
		t.Log("wrong column count after reading invalid unicode code point")
		t.Fail()
	}
	if reader.Offset != 1 {
		t.Log("wrong offset count after reading invalid unicode code point")
		t.Fail()
	}
	...
	if err != nil {
		t.Log("unexpected error when reading valid unicode code point")
		t.Fail()
	}

	if reader.Line != 1 {
		t.Log("wrong line count after reading valid unicode code point")
		t.Fail()
	}
	if reader.Column != 2 {
		t.Log("wrong column count after reading valid unicode code point")
		t.Fail()
	}
	if reader.Offset != 2 {
		t.Log("wrong offset count after reading valid unicode code point")
		t.Fail()
	}
}
...
func TestReadRuneAndCountWithNewLine(t *testing.T) {
	...
	if reader.Line != 2 {
		t.Log("wrong line count after line change")
		t.Fail()
	}
	if reader.Column != 0 {
		t.Log("wrong column count after line change")
		t.Fail()
	}
}
